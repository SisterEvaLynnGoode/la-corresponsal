...
TEACHER.push({ n: 1, meta: 'Teacher guide<br>Ten-day plan', body: `
  ...
  <ul style="font-size:.9rem">
    <li><strong>Photo permissions.</strong> Check whether the yearbook's photo release covers
      student photos in a newspaper that gets distributed. If it doesn't, the packet already
      tells students never to photograph anyone who said no. When in doubt, the drawing option
      always works.</li>
